 ...
 */
public class TemplateActionBuilder implements TemplateHanlder {
    ...
    private void createdInfo(String prefix, List<ObjectInfo> objectInfos, GenConfig config) {
        ...
        String daoPath = config.getGenPath() + "/" + projectName + "/" + prefix + "java/" + config.getPackager().replace(".", "/") + "/action/";
