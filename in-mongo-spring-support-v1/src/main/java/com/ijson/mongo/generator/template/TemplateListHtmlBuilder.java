 ...
 */
public class TemplateListHtmlBuilder implements TemplateHanlder {
        ...
        if (!CollectionUtils.isEmpty(objectInfos)) {
            for (ObjectInfo objectInfo : objectInfos) {
                ...
                FileOperate.getInstance().newCreateFile(
                        daoPath + "list-" + objectInfo.getLowerFirstName() + ".html",
                        TemplateUtil.getTemplate("list-html.templete", maps)
