...
public class FileOperate {
    ...
    public boolean newCreateFile(String filePathAndName, String fileContent) {
        boolean result = false;
        try {
            if (!Strings.isNullOrEmpty(filePathAndName)) {
    ...
    public String getTemplete(String fileName) {
        try {
            return IOUtils.toString(getClass().getClassLoader().getResourceAsStream("template/" + fileName));
        } catch (IOException e) {
